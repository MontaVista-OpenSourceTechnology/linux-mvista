...
#define MX8MM_PAD_GPIO_PU  (MX8MM_IOMUXC_PULLUP_ENABLE|MX8MM_IOMUXC_HYS|MX8MM_IOMUXC_SLOW|MX8MM_IOMUXC_DRIVE(6))
#define MX8MM_PAD_GPIO_PD  (MX8MM_IOMUXC_PULLDOWN_ENABLE|MX8MM_IOMUXC_HYS|MX8MM_IOMUXC_SLOW|MX8MM_IOMUXC_DRIVE(6))
#define MX8MM_PAD_GPIO     (MX8MM_IOMUXC_HYS|MX8MM_IOMUXC_SLOW|MX8MM_IOMUXC_DRIVE(6))
#define MX8MM_PAD_GPIO_OD  (MX8MM_IOMUXC_PULLUP_ENABLE|MX8MM_IOMUXC_HYS|MX8MM_IOMUXC_OPEN_DRAIN|MX8MM_IOMUXC_SLOW|MX8MM_IOMUXC_DRIVE(6))
