...
/* data structure of the Diffie-Hellman parameter */
struct q_dh_param {
	struct q_lint p;
	struct q_lint g;
};
 ...
 */
int32_t q_dh_pk(struct q_lip_ctx *ctx, struct q_lint *xpub,
 ...
 */
int32_t q_dh_ss(struct q_lip_ctx *ctx, struct q_lint *ss,
				   struct q_dh_param *dh, struct q_lint *xpub,
				   struct q_lint *y);
#endif /*_Q_DH_H_*/
